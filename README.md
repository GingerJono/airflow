...
| sharepoint_site_path                             | `sites/propins-migrated2`                                                                                                                  | The sharepoint site path for sharepoint integration.                                                                                                                                                                        |
| sharepoint_library_name                          | `Underwriting Policies and Claims`                                                                                                         | The sharepoint library name for sharepoint integration.                                                                                                                                                                     |
| sharepoint_site_hostname                         | `daleuwuk.sharepoint.com`                                                                                                                  | The sharepoint site hostname for sharepoint integration.                                                                                                                                                                    |
### Connections
...
| cytora            | `generic` (Generic)             | Login: From key vault secret `cytora-client-id`</br>Password: From key vault secret `cytora-client-secret`</br>Extra: `{"workspace":"dale_uw_eu_poc", "auth_audience":"https://gateway.cytora-prod.com", "url_prefix":"https://eu.gateway.cytora-prod.com"}`             | Connection to Cytora, used for further processing of email contents on cytora.         |
